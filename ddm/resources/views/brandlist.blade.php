                   ...
                   <div class="product-image d-flex flex-wrap">
                       @php
                           if ($brand->image != null) {
                               ...
                               echo '<h2 class="mt-0 mb-1"><a href="javascript:void(0)" data-item="brand_id" data-href="' . route('buying_detail',$brand->id) . '" class="text-decoration-none text-white buying-details">' . $brand->name . '</a></h2>';
                           } else {
                               echo '<div class="position-absolute product-title">';
                               echo '<h2 class="mt-0 mb-0"><a href="javascript:void(0)" data-item="brand_id" data-href="' . route('buying_detail',$brand->id) . '" class="text-decoration-none text-dark buying-details">' . $brand->name . '</a></h2>';
                           }
                       @endphp
                   </div>
