    ...
    <ul class="list-unstyled mb-4">
        ...
        <div class="d-flex flex-wrap">
            ...
            @endforeach
            <a href="#" data-href="{{route("edit_dite")}}" data-created_at="{{$key}}" class="py-0 px-2 btn-edit-food">Edit</a>
            <a href="#" data-href="{{route("delete_dite")}}" data-created_at="{{$key}}" class="py-0 px-2 btn-delete-food">Delete</a> 
         </div>                      
        @endforeach    
    </ul>
