   <div class="d-flex mb-3">
           <input type="text" class="data-input-box form-control me-2" placeholder="egg 2, beef 15g"
               aria-label="egg 2, beef 15g" aria-describedby="button-add-meal" id="meal-input-box">
   ...
   <div class="row row-cols-5 recent-meals" id="recent-meals">
       @foreach ($data as $item)
           <div class="col-6 col-md-4 col-lg-3 col-xl-3 col-xxl-3 mb-3">
               ...
               <form action="{{ route('upload_image', 'meal eat') }}" method="post" class="upload-image-form"
